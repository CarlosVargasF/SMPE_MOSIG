...
melted_df[c(1:20),]
```
We need to format the dates correctly. We extract the useful information from the date names and an amount of years to each of them to get the real date. 
